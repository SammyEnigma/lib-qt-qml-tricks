...
Project {
    ...
    references: ["src/QtLibrary.qbs", "import/QtQmlTricks/QmlComponents.qbs", "examples/IconCache/IconCache.qbs", "examples/NiceModels/NiceModels.qbs", "examples/CustomPolygon/CustomPolygon.qbs", "examples/COBS/QtCOBS.qbs", "examples/BitStream/QtBitStream.qbs", "examples/JSONPath/QtJsonPath.qbs"]
